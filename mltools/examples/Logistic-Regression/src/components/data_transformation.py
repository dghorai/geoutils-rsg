...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            categorical_cols = []
            numerical_cols = ['occ_2', 'occ_3', 'occ_4', 'occ_5', 'occ_6', 'occ_husb_2', 'occ_husb_3', 'occ_husb_4',
                              'occ_husb_5', 'occ_husb_6', 'rate_marriage', 'age', 'yrs_married', 'children', 'religious', 'educ']
    ...
    def initiate_data_transformation(self, train_dp, test_dp):
        try:
            ...
            drop_columns = [target_column_name, 'Intercept']
