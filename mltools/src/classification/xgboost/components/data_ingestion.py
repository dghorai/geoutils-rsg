...
class DataIngestionConfig:
    raw_data_path = os.path.join(PRJ_DIR, "artifacts", "classification", "xgboost", "raw.csv")
    train_data_path = os.path.join(PRJ_DIR, "artifacts", "classification", "xgboost", "train.csv")
    test_data_path = os.path.join(PRJ_DIR, "artifacts", "classification", "xgboost", "test.csv")
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            test_df = pd.read_csv(os.path.join(PRJ_DIR, 'notebooks', 'data', 'wage_test_set.csv'), skipinitialspace=True)
