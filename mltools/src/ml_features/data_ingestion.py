...
class DataIngestionConfig:
    raw_data_path = os.path.join(PRJ_DIR, "artifacts", "regression", "random_forest", "raw.csv")
    train_data_path = os.path.join(PRJ_DIR, "artifacts", "regression", "random_forest", "train.csv")
    test_data_path = os.path.join(PRJ_DIR, "artifacts", "regression", "random_forest", "test.csv")
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df = pd.read_csv(os.path.join(
                PRJ_DIR, 'notebooks', 'data', 'boston.csv'))
