...
def construct_perpendicular_line(infc, outfc=None, interval=500, offset=500, save=True, coordsys='GCS'):
    ...
    try:
        ...
        iPts, iSlp = comt.fixed_interval_points(infc, interval, flipline=True, lineslope=True)
        ...
        if save == True:
            ...
            lyr = shapeData.CreateLayer('myLyr2', spr, geom_type=ogr.wkbMultiLineString)
            # create fileds
...
def create_xscl_uniqueid(xscl_available=False, infc=None, outfc=None, uidfield="UID", objectidfield="OBJECTID", linefield="LINEID", interval=500, offset=500, coordsys='GCS'):
    ...
    if xscl_available == True:
        ...
        construct_perpendicular_line(infc=infc, outfc=outfc, interval=interval, offset=offset, coordsys=coordsys)
        objids, lineids = construct_perpendicular_line(infc=infc, interval=interval, offset=offset, save=False, coordsys=coordsys)
